...
public class HLog {
	...
	public HLog(String title, Date goDate, Date comeDate, String open, String contents, String titlePic, String tripStyle,int hice, int dounorNo, String profile, String nickname) {
		super();
		this.hice = hice;
