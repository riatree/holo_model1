...
<div id="content">
    <div class="bestHLog">
        <div class="hLogTitleBox">
            ...
            <% if(loginDounor!=null) {%>
                <a class="writeGo" href="/hlogWriteForm.jsp"><img src="/img/write.png" width="20" height="20"/> 글쓰기</a>
            <%} %>
            </div><!-- .hLogTitle end -->
        ...
        <div class="hLogAll">
            <script type="text/template" id="hlogTmp">
				...
				@>
    				<li>
        				<div class="boxOne">
						<a href="/hlog.jsp?no=<@=hlog.no@>"><div class="photoArea"></div></a>
