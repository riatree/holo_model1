...
<% 
	...
	List<Spot> spots = SpotsDAO.selectLocationFoodList(no);
	List<Spot> lists = SpotsDAO.selectLocationTourList(no);
%>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<div id="heroWrap">
	<img class="heroImg" src="/location/<%=location.getImg() %>" width="100%" height="400px" />
    <div class="infoWrap">
        <h3 class="travelTitle"><%=location.getName() %></h3>
        <div class="cityInfo">
            <ul>
                <li class="clock"><i class="far fa-clock"></i><span>(시차 <%=location.getParallax() %> 시간)</span></li>
                <li class="flyTime"><i class="fas fa-plane-departure"></i> (직항) <%=location.getDirectTime() %> </li>
            </ul>
        </div><!-- //cityInfo -->
        ...
        <ul class = "infoBox">
            ...
            <li class="optimizer list">
                ...
                <div class="infoValue"> <%=location.getGoodDate() %></div>
            </li>
            
            <li class="guide list">
                <a href="/file/<%=location.getGuidebook() %>" download="<%=location.getGuidebook() %>">
                    ...
                    <li class="listBox attractionListBox">
                        <div id="boxWrap">
                            ...
                            <div class="hlogClick hlogStar"><img src="img/star_full.png" width="20" height="20">456</div>
                            	<a href="tourdetail.jsp?no=<%=spot.getNo()%>">
                                
                                <div class="backImage"><img src="/spot/<%=spot.getPicname() %>" width="290" height="200"/></div>
                                </a>
                                <div id="hashBox">
                            ...
                            <div class="box_m">
                                <a class="profile" href="tourDetail.jsp?no=<%=spot.getNo()%>"><img class="user" src="img/user_profile_img.png"></a>
                                <div class="hlogName"><%=spot.getName() %></div>
                                <div class="hlogNickname"><%=spot.getNickname() %></div>
                   ...
                   <% for (Spot spot : spots){ %>
                    ...
                    <li class="listBox restaurantListBox">
                        <div id="boxWrap">
                            <div class="box">
                                <div class="hlogClick hlogStar"><img src="img/star_full.png" width="20" height="20">456</div>
                                <div class="backImage"><img src="/spot/<%=spot.getPicname() %>" /></div>
                                <div id="hashBox">
...
<div id="popinfo" class="popUp">
    ...
    <ul>
        ...
        <li>
            ...
            <div class="itemContent"><%=location.getVoltage() %></div>
        </li>
        <li>
            <div class="item">
            ...
            <div class="itemContent"><%=location.getMoney() %></div>
        </li>
        <li>
            <div class="item"><i class="fas fa-globe"></i>
                <div class="itemTitle">언어</div>
            </div>
            <div class="itemContent"><%=location.getLanguage() %></div>
        </li>
    </ul>
</div> <!-- //popinfo -->
...
<script>
    ...
    function displayTime(){
        var now = moment();
        var time = now.tz('').format("HH:mm:ss");
