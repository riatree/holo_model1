...
<%
	...
	//Together togetherOne = TogethersDAO.selectOnePop();
	...
	List<Together> togetherPage = TogethersDAO.selectFoodList(pageVO);
...
<div id="searchWrap">
    <a class="apply" href="/togetherRegister.jsp"> 동행등록 </a>
        	...
        	%>
                <li class="togetherList">
                    <div class="together">
                        ...
                        <div class="personnel">
                        	<%=result %>/<%=together.getPersonnel()%>명
                        </div>
                        <div class="gender"><img src="<%=urlImg%>"></div>
                        <div class="finish"><% if(result == together.getPersonnel() || now>=that) {
