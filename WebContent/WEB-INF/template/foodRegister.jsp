...
<%-- 은서 : 모든 곳에 name 추가 --%>
    ...
    <div id="restaurantRegisterBox">
        ...
        <div class="form">
        	<%-- 은서 : action, method 추가 --%>  
            <form action="/foodRegisterNon.jsp" method="post" name="form">
            
            	<%-- 은서 : 이미지 이름, hice값 가져오는 input --%>
            	<input type="hidden" id="uploadName" name="upload"/>
                ...
                <fieldset>
                    ...
                    <div class="photo">
                        ...
                        <%-- 은서 : canvas -> div 로 변경 / class 추가 --%>
                        <div class="photoBox no_image far fa-image">
                        <%-- foodRegister.css 약간 수정, img 추가 --%>
                        <img src="/spot/defaultpic.png" width="160" height="120" id="uploadImg"/>
                        </div>
                    ...
                    <div class="restaurantName">
                        <em>음식점 명</em> <input name="foodName" placeholder="음식점 이름을 입력해주세요" />
                    ...
                    <div class="restaurantAddr">
                        <em>주소</em>
                        <input class="addr1" name="foodAddr1" placeholder="주소를 입력해주세요"/> <button type="button">google Map</button>
                        <input class="addr2" name="foodAddr2" placeholder="상세주소를 입력해주세요"/>
                        <input id="placeLat" type="hidden" name="lat" value="">
                        <input id="placeLng" type="hidden" name="lng" value="">
                    </div><!-- .restaurantAddr end -->

                    <div class="restaurantCall">
                        <em>연락처</em> <input name="foodCall1" /> - <input name="foodCall2" /> - <input name="foodCall3" />
                    </div><!-- .restaurantCall end -->

                    <div class="restaurantTime">
                        <em>운영시간</em>
                        <select name="foodOpenHour">
                            <% for(int i = 0; i <= 23; i++) { 
                        		if(i < 10) { %>
                            <option>0<%=i %></option>
                            <% } else { %>
                    ...
                    <div class="restaurantMenu">
                        ...
                        <ul class="menuList">
                            <li>
                                ...
                                <!--<span class="oneMenuName">짜장게티</span>-->
                                <!--<i class="fas fa-ellipsis-h"></i>-->
                                <!--<span class="oneMenuPrice">1000</span>원-->
                            </li>
                        </ul>
            ...
            --><img id="won4" class="won" src="img/won.png"/>
                                <span class="range-sliderValue">0</span><span>원</span>
                                <input type="hidden" id="price" name="foodPrice" value="">                             
                            </div>
                        </div>
                    </div><!-- .restaurantMoney end -->

                    <div class="restaurantContent">
                        <em>소개</em> <textarea name="foodContent"></textarea>
