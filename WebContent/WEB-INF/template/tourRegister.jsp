...
<%-- 은서 : 모든 곳에 name 추가 --%>
    ...
    <div id="attractionRegisterBox">
        ...
        <div class="form">
			<%-- 은서 : action, method 추가 --%>        
            <form action="/tourRegisterNon.jsp" method="post" name="form">
                ...
                <fieldset>
                    ...
                    <div class="attractionName">
                        <em>관광명소 명</em> <input name="tourName" placeholder="관광명소 이름을 입력해주세요" />
                    ...
                    <div class="attractionAddr">
                        <em>주소</em>
                        <input class="addr1" name="tourAddr1" placeholder="주소를 입력해주세요"/> <button type="button">google Map</button>
                        <input class="addr2" name="tourAddr2" placeholder="상세주소를 입력해주세요"/>
                    ...
                    <div class="attractionCall">
                        <em>연락처</em> <input name="tourCall1" /> - <input name="tourCall2" /> - <input name="tourCall3" />
                    </div><!-- .attractionCall end -->

                    <div class="attractionTime">
                        <em>운영시간</em>
                        <select name="tourOpenHour">
                            <% for(int i = 0; i <= 23; i++) { 
                        		if(i < 10) { %>
                            <option>0<%=i %></option>
                            <% } else { %>
                    ...
                    <div class="attractionSite">
                        <em>웹사이트</em> <input name="tourSite" placeholder="웹사이트 주소를 입력해주세요" />
                    </div><!-- .attractionSite end -->

                    <div class="attractionMoney">
                        <em>입장료</em> <input name="tourPrice" placeholder="숫자만 입력해주세요"/>
                    </div><!-- .attractionMoney end -->

                    <div class="attractionContent">
                        <em>소개</em> <textarea name="tourContent"></textarea>
