        ...
        <div id="joinBox">
            <form action="register.jsp" method="post">
                <fieldset>
                    ...
                    <div class="row">
                        <span class="label">선호하는 여행타입</span>
                        <p id="theme">
                            <label><input type="checkbox" name="theme" value="H" />힐링</label>
                            <label><input type="checkbox" name="theme" value="A"/>액티비티</label>
                            <label><input type="checkbox" name="theme" value="N"/>야경</label>
                            <label><input type="checkbox" name="theme" value="F"/>감성</label>
                            <label><input type="checkbox" name="theme" value="E"/>식도락</label>
                            <label><input type="checkbox" name="theme" value="T"/>TV여행</label>
                            <label><input type="checkbox" name="theme" value="C"/>도심</label>
                            <label><input type="checkbox" name="theme" value="Y"/>역사·문화</label>
                        </p><!--//theme-->
                        <div class="msg theme">추천받고 싶은 테마가 있다면 선택해주세요.</div>
                    </div><!--//row-->
...
<script>
    ...
    $('#theme input').on("change",function () {
        console.log($("#theme input:checked").length);
        if($("#theme input:checked").length < 4) {
